...
<html lang="en"><head>
    ...
    <title>Bootstrap Editable jQuery Grid - Bootsnipp.com</title>
...
<script type="text/javascript" src="shortGridData.js"></script>
    ...
    $(document).ready(function () {
        $("#grid").shieldGrid({
            ...
            columns: [
                ...
                { field: "month", title: "Date of Birth", format: "{0:Y-m-d}", width: "120px" },
